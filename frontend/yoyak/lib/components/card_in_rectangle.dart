...
class CardInRectangle extends StatelessWidget {
  const CardInRectangle({super.key, this.subTitle, this.title, this.imagePath, this.titleImagePath});
              ...
              Row(
                children: [
                  ...
                  if (titleImagePath != null)
                    Image.asset(titleImagePath, width: 50, height: 50,),
                ],

              ),
              // Spacer 제거 또는 SizedBox로 변경
              const SizedBox(height: 10), // 예시로 추가한 SizedBox
              if (imagePath != null) Image.asset(imagePath, width: 70, height: 70,),
              SizedBox(
                width: cardListWidth,
                height: 250,
